...
import { gcpAlbumPhotoEnding, gcpAlbumPhotoBlurredEnding, gcpBaseURL } from 'data/globals';
      ...
      <div>
        <div>
          <Image
            ...
            placeholder="blur"
            blurDataURL={`${gcpBaseURL}/${collection.folder}/${collection.albumPhoto + gcpAlbumPhotoBlurredEnding}`}
            width={250}
            height={250}
          />
        </div>
